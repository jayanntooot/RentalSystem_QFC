...
{
    public partial class perCartridge : Form
    {
        public perCartridge()
        {
            InitializeComponent();
        ...
        private void perCartridge_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            string query = "SELECT *,YEAR(dueDate) AS duedate_year,MONTH(dueDate) as duedate_month, DAY(dueDate) as duedate_day FROM qry_monthly WHERE type_rentalDescription = 'Per Cartridge Rental' ORDER BY payment_status DESC";
